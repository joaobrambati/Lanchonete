...
namespace Lanchonete.Migrations
{
    ...
    public partial class PopularLanches : Migration
    {
        ...
        {
            migrationBuilder.Sql("INSERT INTO Lanches(CategoriaId, DescricaoCurta, DescricaoDetalhada, TemEstoque, ImagemThumbnailUrl, ImagemUrl, LanchePreferido, Nome, Preco) " +
                "VALUES(1, 'Pão, hambúrger, ovo, presunto, queijo e batata palha', 'Delicioso hamburger com ovo frito; presunto e queijo de primeira qualidade acompanhado com batata palha', 1, 'http://www.macoratti.net/Imagens/lanches/cheesesalada1.jpg', 'http://www.macoratti.net/Imagens/lanches/cheesesalada1.jpg', 0, 'Cheese Salada', 12.50)");
        ...
        {
            migrationBuilder.Sql("DELETE FROM Lancges");
        }
    }
}
